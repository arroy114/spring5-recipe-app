package wai.spring5recipeapp.bootstrap;
...
import wai.spring5recipeapp.domain.*;
import wai.spring5recipeapp.repositories.CategoryRepository;
import wai.spring5recipeapp.repositories.RecipeRepository;
import wai.spring5recipeapp.repositories.UnitOfMeasureRepository;
...
@Slf4j //used to logging
@Component
//ApplicationListener is part of Spring Framework, while CommandLineRunner is part of Spring Boot.
...
//public class RecipeBootstrap implements CommandLineRunner {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.debug("Loading Bootstrap data"); //Using the lombok Slf4j to logging
    }
